            ...
            <form @submit.prevent="updateUser">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                  ...
                  <div class="pt-4">
                    <h4 class="font-medium text-gray-700 mb-2">Options de sécurité</h4>

                    <div class="space-y-4">
                      <div class="flex items-center justify-between">
                        <div class="text-sm">
                          <span class="font-medium text-gray-700">Réinitialiser le mot de passe</span>
                          <p class="text-gray-500">Envoyer un email de réinitialisation du mot de passe à l'utilisateur</p>
                        </div>
                        <button
                          type="button"
                ...
                <div class="space-y-6">
                  ...
                  <div class="bg-gray-50 p-4 rounded-lg">
                    <h4 class="font-medium text-gray-700 mb-4">Appartenances aux équipes</h4>
                  ...
                  <div class="bg-gray-50 p-4 rounded-lg">
                    <h4 class="font-medium text-gray-700 mb-2">Statistiques de l'utilisateur</h4>

                    <div class="space-y-2">
                      <div class="flex justify-between">
                        <span class="text-sm text-gray-500">Tâches assignées:</span>
                        <span class="text-sm font-medium">{{ userStats.tasksCount || 0 }}</span>
                      </div>
                      <div class="flex justify-between">
                        <span class="text-sm text-gray-500">Tâches complétées:</span>
                        <span class="text-sm font-medium">{{ userStats.completedTasksCount || 0 }}</span>
                      </div>
                      <div class="flex justify-between">
                        <span class="text-sm text-gray-500">Taux de complétion:</span>
                        <span class="text-sm font-medium">{{ userStats.completionRate || 0 }}%</span>
                      </div>
                      <div class="flex justify-between">
                        <span class="text-sm text-gray-500">Dernière connexion:</span>
                        <span class="text-sm font-medium">{{ userStats.lastLogin || 'Jamais' }}</span>
                      </div>
                    </div>
                  </div>

                  <div class="bg-gray-50 p-4 rounded-lg">
                    <h4 class="font-medium text-gray-700 mb-2">Actions avancées</h4>
