          ...
          <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            ...
            <div class="flex flex-col md:flex-row gap-4 mb-6">
              ...
              <div class="w-full md:w-auto md:self-end">
                <button
                  type="button"
                  class="w-full md:w-auto inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                  @click="resetFilters"
                >
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                      <div class="flex items-center">
                        ...
                        <div class="ml-4">
                          ...
                          <div v-if="user.id === $page.props.auth.user.id" class="text-xs text-gray-500">(Vous)</div>
                        </div>
                      </div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
            ...
            <!-- Pagination -->
            <div class="mt-6 px-4 py-3 bg-gray-50 text-xs font-medium uppercase text-gray-500 border-t border-gray-200">
            <div class="flex justify-between items-center">
                <div>
