<template>
    <AppLayout title="Gestion des équipes">
          ...
          <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            ...
            <div class="flex flex-col md:flex-row gap-4 mb-6">
              ...
              <div class="w-full md:w-auto md:self-end">
                <button
                  type="button"
                  class="w-full md:w-auto inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
                  @click="resetFilters"
                >
              ...
              <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                  <tr>
                    ...
                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Création</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  <tr v-for="team in teams.data" :key="team.id">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                      <div class="text-sm text-gray-900">{{ team.owner ? team.owner.name : 'N/A' }}</div>
            ...
            <!-- Pagination simple -->
            <div v-if="teams.data.length > 0" class="mt-6 px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-6">
      ...
      <div v-if="confirmingTeamDeletion" class="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
