        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
          ...
          <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6 mb-6">
            <div class="flex flex-wrap items-center">
              ...
              <div class="mr-4 mb-2">
                <label for="searchFilter" class="block text-sm font-medium text-gray-700 mb-1">Recherche</label>
                <input
                  id="searchFilter"
          ...
          <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            <div v-if="filteredProjects.length" class="space-y-6">
              <div
                ...
                :key="project.id"
                class="border p-6 rounded-lg hover:bg-gray-50 transition duration-150"
              >
                <Link :href="route('projects.show', project.id)" class="block">
                  <div class="flex justify-between items-start">
                    <div>
                      <h3 class="text-xl font-bold text-gray-900">{{ project.name }}</h3>
                      <p v-if="project.description" class="mt-2 text-gray-600 line-clamp-2">
                        {{ project.description }}
                      </p>
                    </div>
                  ...
                  <div class="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <!-- Objectifs -->
                    <div class="bg-gray-50 p-3 rounded">
                      <div class="text-sm font-medium text-gray-500">Objectifs</div>
                      <div class="mt-1 flex items-center">
                        <div class="font-medium">
                    ...
                    <!-- Dates -->
                    <div class="bg-gray-50 p-3 rounded">
                      <div class="text-sm font-medium text-gray-500">Période</div>
