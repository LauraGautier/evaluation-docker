            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div v-if="conversations.length === 0" class="text-center py-12">
                        ...
                        <p class="mt-1 text-sm text-gray-500">Commencez par envoyer un message à un collaborateur.</p>
                        <div class="mt-6">
                            <Link :href="route('messages.create')" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                    ...
                                    <div class="flex items-center min-w-0">
                                        ...
                                        <div class="ml-4 flex-1">
                                            <div class="flex items-center">
                                                ...
                                                <span v-if="conversation.unread_count > 0" class="ml-2 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
